...
const CaseStudySection: React.FC = () => {
  ...
  useGSAP(() => {
    ...
    // Reduced radius for mobile to match smaller card size (170px width)
    const radius = isMobile ? 150 : 420; 
  ...
  return (
    ...
    >
       ...
       <div className="relative w-full h-full flex items-center justify-center max-h-[100vh]" style={{ perspective: '2000px' }}>
          ...
          <div 
            ref={carouselRef}
            className="w-[170px] md:w-[300px] aspect-[2/3] relative will-change-transform"
