...
const CASES: CaseStudy[] = [
  {
    ...
    description:
      "Designed 4000+ screens across appointments, sales, inventory, and CMS to build a single connected ecosystem.",
    image:
  ...
  },
  {
    ...
    description:
      "Chrome extension for product managers that generates PRDs, analyses documents, and automates workflows.",
    image:
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=2670&auto=format&fit=crop",
    link: "https://www.figma.com",
  },
  {
    ...
    description:
      "End-to-end edtech ecosystem covering admissions, exams, fee payments, and complete academic management.",
    image:
...
const CaseStudySection: React.FC = () => {
  ...
  useGSAP(
    () => {
      ...
      // Increased radius for mobile to match larger card width (75vw)
  ...
  return (
    ...
    >
      ...
      {/* 3D Scene Container */}
      <div
        className="relative w-full h-full flex items-center justify-center max-h-[100vh]"
        style={{ perspective: "2000px" }}
      >
        {/* Rotating Carousel Wrapper */}
        <div
          ref={carouselRef}
          className="w-[75vw] md:w-[300px] aspect-[2/3] relative will-change-transform"
        ...
        >
          {CASES.map((item, index) => (
            ...
            >
              ...
              {/* Content */}
              <div
                className="flex flex-col h-[35%] justify-between text-black px-2 pb-2"
        ...
        <div className="absolute bottom-6 md:bottom-12 z-20">
          <Magnetic>
            ...
            >
              ...
              <ArrowUpRight
                size={18}
                className="relative z-10 group-hover:text-black group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300"
              />
            </button>
          </Magnetic>
        </div>
